...
(async () => {
  ...
  await page.screenshot({ path: '/root/.gemini/antigravity-cli/brain/bfb6bc14-0e2d-467f-a98c-0afe96083982/step1_before.png' });
  
  console.log("Captured step1_before.png");
  await browser.close();
})();
