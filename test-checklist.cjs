...
(async () => {
  console.log('🚀 Launching browser for Checklist E2E...');
  ...
  const tests = [
    { name: '최저임금 안내 문구', condition: pageText.includes('최저시급(10,030원)') },
    { name: '휴게시간 안내 문구', condition: pageText.includes('휴게시간이 잘 포함되어 있는지') },
    { name: '4대보험 안내 문구', condition: pageText.includes('4대보험(국민연금, 건강보험, 고용보험, 산재보험) 조항이 누락되지 않았는지') },
