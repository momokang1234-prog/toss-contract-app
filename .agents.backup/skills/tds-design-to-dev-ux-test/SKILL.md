...
4. **Delegate for Mock Previews**: BEFORE asking the user to choose, you MUST pass the `design-{timestamp}.json` to the implementation agent (`ui-builder` or `toss-app-dev:toss-mini-app`). Instruct the agent to:
