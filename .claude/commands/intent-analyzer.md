...
1. **User Communication & Cognitive Gap**: Clarify vague requests, check for typos.
2. **Codebase Context & Technical Alignment**: Map to physical files — see `.omp/skills/intent-analyzer/references/mapping.md`.
...
Do not execute immediately. Output an analysis using the following structured format:
...
- Refer to `.omp/skills/intent-analyzer/references/routing-protocol.md` for task delegation.
- Define handshake and discussion points between agents.

---

## 8 Perspectives Reference
See `.omp/skills/intent-analyzer/references/8-perspectives.md` for detailed actions per perspective.

## Additional References
- `.omp/skills/intent-analyzer/examples/reframing-examples.md` — Few-shot examples of analyzing and reframing requests.
- `.omp/skills/intent-analyzer/references/classification.md` — Detailed guide to request classification and routing criteria.
- `.omp/skills/intent-analyzer/references/mapping.md` — Reference map of codebase files and directories.
- `.omp/skills/intent-analyzer/references/routing-protocol.md` — Protocol for multi-agent coordination, task dispatch, and consensus.
