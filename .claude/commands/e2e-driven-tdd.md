...
**Reference:** `.claude/commands/e2e-driven-tdd/references/phase1-planning.md`
...
**Reference:** `.claude/commands/e2e-driven-tdd/references/phase2-automation.md`
...
**Reference:** `.claude/commands/e2e-driven-tdd/references/phase3-execution.md`
...
**Reference:** `.claude/commands/e2e-driven-tdd/references/phase4-stabilization.md`
...
## Case Study / Example
- `.claude/commands/e2e-driven-tdd/references/examples/toss-contract-success.md` — Real-world example of stabilizing the Toss Contract App using this exact pipeline, including debug hooks and mock bypass strategies.
