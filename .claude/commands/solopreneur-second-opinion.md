...
**Method:** Dispatch an Antigravity subagent (`Agent` tool) to perform the review with a clean context window.
...
- **Subagent Type**: `toss-app-dev-review-board` (for frontend/architecture) or `general-purpose`
