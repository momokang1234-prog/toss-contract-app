...
await browser.close();
```
- **Agent Action After Test**: After the test completes, you MUST use the `Read` tool to open `final_state_capture.png`. Check the visual output with your own eyes before telling the user the test was successful.
